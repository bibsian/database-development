...
def test_site_in_project_key(
        MergeToUpload, site_handle_1_count, file_handle_1_count,
    ...
    lter = meta_handle_1_count.lnedentry['lter']
    ...
    print(rawtable)
    facade.push_tables[count_handle_1_count.tablename] = rawtable
    facade.create_log_record(count_handle_1_count.tablename)
