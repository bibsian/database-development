...
# Form implementation generated from reading ui file 'C:\Users\MillerLab\Desktop\database-development\test\Views\ui_dialog_time.ui'
#
...
""))
        ...
        Dialog.setTabOrder(self.lnedDay, self.cboxDay)
        Dialog.setTabOrder(self.cboxDay, self.lnedMonth)
        Dialog.setTabOrder(self.lnedMonth, self.cboxMonth)
        Dialog.setTabOrder(self.cboxMonth, self.lnedYear)
        Dialog.setTabOrder(self.lnedYear, self.cboxYear)
        Dialog.setTabOrder(self.cboxYear, self.ckJulian)
        Dialog.setTabOrder(self.ckJulian, self.ckMonthSpelling)
        Dialog.setTabOrder(self.ckMonthSpelling, self.btnSaveClose)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cboxYear.setItemText(0, _translate("Dialog", "NULL", None))
        self.cboxYear.setItemText(1, _translate("Dialog", "dd - mm - YYYY (Any Order)", None))
        self.cboxYear.setItemText(2, _translate("Dialog", "dd - mm - YY (Any Order)", None))
        self.cboxYear.setItemText(3, _translate("Dialog", "dd - YYYY (Any Order)", None))
        self.cboxYear.setItemText(4, _translate("Dialog", "dd - YY (Any Order)", None))
        self.cboxYear.setItemText(5, _translate("Dialog", "mm - YYYY (Any Order)", None))
        self.cboxYear.setItemText(6, _translate("Dialog", "mm - YY (Any Order)", None))
        self.cboxYear.setItemText(7, _translate("Dialog", "YYYY", None))
        self.cboxYear.setItemText(8, _translate("Dialog", "YY", None))
        self.cboxYear.setItemText(9, _translate("Dialog", "Julian day", None))
        self.cboxDay.setItemText(0, _translate("Dialog", "NULL", None))
        self.cboxDay.setItemText(1, _translate("Dialog", "dd - mm - YYYY (Any Order)", None))
        self.cboxDay.setItemText(2, _translate("Dialog", "dd - mm - YY (Any Order)", None))
        self.cboxDay.setItemText(3, _translate("Dialog", "dd - mm (Any Order)", None))
        self.cboxDay.setItemText(4, _translate("Dialog", "dd - YYYY (Any Order)", None))
        self.cboxDay.setItemText(5, _translate("Dialog", "dd - YY (Any Order)", None))
        self.cboxDay.setItemText(6, _translate("Dialog", "dd", None))
        ...
        self.cboxMonth.setItemText(1, _translate("Dialog", "dd - mm - YYYY (Any Order)", None))
        self.cboxMonth.setItemText(2, _translate("Dialog", "dd - mm - YY (Any Order)", None))
        self.cboxMonth.setItemText(3, _translate("Dialog", "dd - mm (Any Order)", None))
        self.cboxMonth.setItemText(4, _translate("Dialog", "mm - YYYY (Any Order)", None))
        self.cboxMonth.setItemText(5, _translate("Dialog", "mm - YY (Any Order)", None))
        self.cboxMonth.setItemText(6, _translate("Dialog", "mm", None))
        self.label_2.setText(_translate("Dialog", "Month", None))
        self.label.setText(_translate("Dialog", "Day", None))
        self.label_5.setToolTip(_translate("Dialog", "<html><head/><body><p><span style=\" text-decoration: underline;\">Format Examples</span></p><p>YYYY = 1996</p><p>YY = 96</p><p><br/></p></body></html>", None))
