...
""))
        ...
        Dialog.setTabOrder(self.cboxDay, self.ckDay)
        Dialog.setTabOrder(self.ckDay, self.lnedMonth)
        Dialog.setTabOrder(self.lnedMonth, self.cboxMonth)
        Dialog.setTabOrder(self.cboxMonth, self.ckMonth)
        Dialog.setTabOrder(self.ckMonth, self.lnedYear)
        Dialog.setTabOrder(self.lnedYear, self.cboxYear)
        Dialog.setTabOrder(self.cboxYear, self.ckYear)
        Dialog.setTabOrder(self.ckYear, self.ckJulian)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cboxDay.setItemText(3, _translate("Dialog", "dd - YYYY (Any Order)", None))
        self.cboxDay.setItemText(4, _translate("Dialog", "dd - YY (Any Order)", None))
        ...
        self.cboxMonth.setItemText(3, _translate("Dialog", "mm - YYYY (Any Order)", None))
        self.cboxMonth.setItemText(4, _translate("Dialog", "mm - YY (Any Order)", None))
        self.cboxMonth.setItemText(5, _translate("Dialog", "mm", None))
