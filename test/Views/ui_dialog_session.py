...
""))
        ...
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.groupBoxMeta)
        ...
        self.cboxLTERloc.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.cboxLTERloc.addItem(_fromUtf8(""))
        self.cboxLTERloc.addItem(_fromUtf8(""))
        self.horizontalLayout_2.addWidget(self.cboxLTERloc)
        ...
        self.lnedMetadataUrl.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.horizontalLayout_2.addWidget(self.lnedMetadataUrl)
        ...
        self.btnVerifyMeta.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.verticalLayout = QtGui.QVBoxLayout(self.groupBoxFile)
        ...
        self.rbtnTxt.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.lnedDelimiter.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.lnedSkipTop.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.lnedSkipBottom.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.lnedExcelSheet.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.rbtnExcel.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.formLayout_2.setWidget(1, QtGui.QFormLayout.LabelRole, self.btnSelectFile)
        self.verticalLayout.addLayout(self.formLayout_2)
        self.verticalLayout_3.addWidget(self.groupBoxFile)
        ...
        Dialog.setTabOrder(self.btnVerifyMeta, self.rbtnExcel)
        Dialog.setTabOrder(self.rbtnExcel, self.rbtnTxt)
        Dialog.setTabOrder(self.rbtnTxt, self.btnSaveClose)
