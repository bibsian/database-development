...
"}"))
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1147, 31))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "DataFormater", None))
        ...
        self.actionStart_Session.setShortcut(_translate("MainWindow", "Meta+N", None))
        ...
        self.actionSiteTable.setText(_translate("MainWindow", "SiteTable", None))
        self.actionMainTable.setText(_translate("MainWindow", "MainTable", None))
        self.actionTaxaTable.setText(_translate("MainWindow", "TaxaTable", None))
        self.actionRawTable.setText(_translate("MainWindow", "RawTable", None))
        self.actionClimateSiteTable.setText(_translate("MainWindow", "ClimateSiteTable", None))
        self.actionClimateRawTable.setText(_translate("MainWindow", "ClimateRawTable", None))
        self.actionModify_ontomany_entries.setText(_translate("MainWindow", "Modify one to many records..", None))
        self.actionActionTemporalParser.setText(_translate("MainWindow", "Temporal Parser", None))
