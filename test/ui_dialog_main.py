...
""))
        ...
        self.btnSiteClose = QtGui.QPushButton(Dialog)
        self.btnSiteClose.setObjectName(_fromUtf8("btnSiteClose"))
        self.horizontalLayout_7.addWidget(self.btnSiteClose)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox.setTitle(_translate("Dialog", "Enter Metadata Inofmration", None))
        self.label_3.setText(_translate("Dialog", "Metadata Table", None))
        self.btnSiteClose.setText(_translate("Dialog", "Save && Close", None))
