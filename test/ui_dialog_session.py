...
""))
        ...
        self.horizontalLayout_2 = QtGui.QHBoxLayout(self.groupBoxMeta)
        ...
        self.formLayout.setWidget(1, QtGui.QFormLayout.LabelRole, self.btnVerifyMeta)
        self.horizontalLayout_2.addLayout(self.formLayout)
        self.verticalLayout_2.addWidget(self.groupBoxMeta)
        ...
        self.verticalLayout_2.addWidget(self.groupBoxFile)
