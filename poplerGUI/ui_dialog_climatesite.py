...
# Form implementation generated from reading ui file '/Users/bibsian/Desktop/git/database-development/test/Views/ui_dialog_climatesite.ui'
#
...
""))
        ...
        self.formLayout.setWidget(2, QtGui.QFormLayout.LabelRole, self.ckCreate)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_4.setText(_translate("Dialog", "Identify Climate station Information", None))
        self.label.setText(_translate("Dialog", "Climate Station", None))
        self.btnSiteID.setText(_translate("Dialog", "Submit", None))
        self.ckCreate.setText(_translate("Dialog", "Create station name", None))
