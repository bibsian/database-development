...
# File to edit
filename = "sev238_pdogvegcover_20160701.csv"
...
data$treatment <- NA
data$treatment[
  which(as.character(data$PLOT)=='A' | as.character(data$PLOT)=='C')] <- 'control'
data$treatment[
  which(as.character(data$PLOT)=='B' | as.character(data$PLOT)=='D')] <- 'treatment'
