...
""))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ckStructure3.setText(_translate("Dialog", "No Strucutre Type 3", None))
        self.ckStructure2.setText(_translate("Dialog", "No Strucutre Type 2", None))
        self.ckStructure.setText(_translate("Dialog", "No Structure Type ", None))
