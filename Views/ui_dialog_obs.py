...
# Form implementation generated from reading ui file 'ui_dialog_obs.ui'
#
...
""))
        ...
        self.ckRaw = QtGui.QCheckBox(self.groupBox)
        self.ckRaw.setFocusPolicy(QtCore.Qt.TabFocus)
        self.ckRaw.setObjectName(_fromUtf8("ckRaw"))
        self.gridLayout.addWidget(self.ckRaw, 9, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lnedRaw, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lnedRep4, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.ckRep3, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lnedRep3, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lnedStructure, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.ckStructure, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.ckRep4, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lnedRep2, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.ckRep2, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lnedRep1, 3, 1, 1, 1)
        self.label = QtGui.QLabel(self.groupBox)
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName(_fromUtf8("label"))
        self.gridLayout.addWidget(self.label, 2, 1, 1, 1)
        self.lnedTreatment = QtGui.QLineEdit(self.groupBox)
        self.lnedTreatment.setObjectName(_fromUtf8("lnedTreatment"))
        self.gridLayout.addWidget(self.lnedTreatment, 8, 1, 1, 1)
        self.ckTreatment = QtGui.QCheckBox(self.groupBox)
        self.ckTreatment.setObjectName(_fromUtf8("ckTreatment"))
        self.gridLayout.addWidget(self.ckTreatment, 8, 2, 1, 1)
        self.label_9 = QtGui.QLabel(self.groupBox)
        self.label_9.setObjectName(_fromUtf8("label_9"))
        self.gridLayout.addWidget(self.label_9, 8, 0, 1, 1)
        self.ckCount = QtGui.QCheckBox(self.groupBox)
        self.ckCount.setObjectName(_fromUtf8("ckCount"))
        self.gridLayout.addWidget(self.ckCount, 0, 0, 1, 1)
        self.ckDensity = QtGui.QCheckBox(self.groupBox)
        self.ckDensity.setObjectName(_fromUtf8("ckDensity"))
        self.gridLayout.addWidget(self.ckDensity, 0, 2, 1, 1)
        self.ckBiomass = QtGui.QCheckBox(self.groupBox)
        self.ckBiomass.setObjectName(_fromUtf8("ckBiomass"))
        self.gridLayout.addWidget(self.ckBiomass, 0, 1, 1, 1)
        self.ckPercentcover = QtGui.QCheckBox(self.groupBox)
        self.ckPercentcover.setObjectName(_fromUtf8("ckPercentcover"))
        self.gridLayout.addWidget(self.ckPercentcover, 1, 0, 1, 1)
        self.ckIndividual = QtGui.QCheckBox(self.groupBox)
        self.ckIndividual.setObjectName(_fromUtf8("ckIndividual"))
        self.gridLayout.addWidget(self.ckIndividual, 1, 1, 1, 1)
        ...
        Dialog.setTabOrder(self.ckStructure, self.lnedTreatment)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ckRaw.setText(_translate("Dialog", "Indivdual ID\'s Present", None))
        ...
        self.ckTreatment.setText(_translate("Dialog", "Not an experimental dataset", None))
        self.label_9.setText(_translate("Dialog", "Treatment", None))
        self.ckCount.setText(_translate("Dialog", "Counts", None))
        self.ckDensity.setText(_translate("Dialog", "Density", None))
        self.ckBiomass.setText(_translate("Dialog", "Biomass", None))
        self.ckPercentcover.setText(_translate("Dialog", "Percent cover", None))
        self.ckIndividual.setText(_translate("Dialog", "Individual", None))
