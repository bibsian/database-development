...
""))
        ...
        self.lnedValuecolumns_2 = QtGui.QLineEdit(self.groupBox)
        self.lnedValuecolumns_2.setObjectName(_fromUtf8("lnedValuecolumns_2"))
        self.horizontalLayout_2.addWidget(self.lnedValuecolumns_2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Split Column On", None))
