...
""))
        ...
        Dialog.setTabOrder(self.lnedPhylum, self.lnedClass)
        Dialog.setTabOrder(self.lnedClass, self.lnedOrder)
        Dialog.setTabOrder(self.lnedOrder, self.ckFamily)
        Dialog.setTabOrder(self.ckFamily, self.lnedFamily)
        Dialog.setTabOrder(self.lnedFamily, self.lnedGenus)
        Dialog.setTabOrder(self.lnedGenus, self.lnedSpp)
