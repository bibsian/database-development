...
"\n"
""))
        self.horizontalLayout_49 = QtGui.QHBoxLayout(Dialog)
        ...
        self.cboxStudy = QtGui.QComboBox(self.groupBox_3)
        self.cboxStudy.setObjectName(_fromUtf8("cboxStudy"))
        self.cboxStudy.addItem(_fromUtf8(""))
        self.cboxStudy.addItem(_fromUtf8(""))
        self.cboxStudy.addItem(_fromUtf8(""))
        self.verticalLayout_5.addWidget(self.cboxStudy)
        ...
        self.cboxDerived.addItem(_fromUtf8(""))
        self.cboxDerived.addItem(_fromUtf8(""))
        self.cboxDerived.setItemText(3, _fromUtf8(""))
        ...
        self.horizontalLayout_45.addWidget(self.groupBox_7)
        self.verticalLayout_13.addLayout(self.horizontalLayout_45)
        self.verticalLayout_14.addLayout(self.verticalLayout_13)
        spacerItem9 = QtGui.QSpacerItem(28, 18, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        self.lnedStuctureunits3 = QtGui.QLineEdit(self.groupBox_4)
        self.lnedStuctureunits3.setObjectName(_fromUtf8("lnedStuctureunits3"))
        self.horizontalLayout_38.addWidget(self.lnedStuctureunits3)
        ...
        spacerItem17 = QtGui.QSpacerItem(28, 18, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        spacerItem26 = QtGui.QSpacerItem(13, 17, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_46.addItem(spacerItem26)
        self.verticalLayout_14.addLayout(self.horizontalLayout_46)
        self.verticalLayout_15.addLayout(self.verticalLayout_14)
        self.label.raise_()
        self.cboxDatatype.raise_()
        self.label_3.raise_()
        self.lnedDatatypeunits.raise_()
        self.label_4.raise_()
        self.rbtnCommunityyes.raise_()
        self.rbtnCommunityno.raise_()
        self.groupBox_2.raise_()
        self.label_15.raise_()
        self.cboxStudy.raise_()
        ...
        self.btnViewmetadata = QtGui.QPushButton(Dialog)
        self.btnViewmetadata.setObjectName(_fromUtf8("btnViewmetadata"))
        self.horizontalLayout_48.addWidget(self.btnViewmetadata)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cboxStudy.setItemText(0, _translate("Dialog", "NULL", None))
        self.cboxStudy.setItemText(1, _translate("Dialog", "obs", None))
        self.cboxStudy.setItemText(2, _translate("Dialog", "exp", None))
...
"Units", None))
        ...
        self.label_20.setText(_translate("Dialog", "Structure 1", None))
        self.label_21.setText(_translate("Dialog", "Units", None))
        self.label_22.setText(_translate("Dialog", "Structure 2", None))
        self.label_23.setText(_translate("Dialog", "Units", None))
        self.label_24.setText(_translate("Dialog", "Structure 3", None))
        self.label_25.setText(_translate("Dialog", "Units", None))
        self.groupBox_2.setTitle(_translate("Dialog", "Spatial Replication", None))
        self.label_5.setText(_translate("Dialog", "Level 1 Extent", None))
        self.label_10.setText(_translate("Dialog", "Units", None))
        self.label_6.setText(_translate("Dialog", "Level 2 Extent", None))
        self.label_11.setText(_translate("Dialog", "Units", None))
        self.label_7.setText(_translate("Dialog", "Level 3 Extent", None))
        self.label_12.setText(_translate("Dialog", "Units", None))
        self.label_8.setText(_translate("Dialog", "Level 4 Extent", None))
        self.label_13.setText(_translate("Dialog", "Units", None))
        self.label_9.setText(_translate("Dialog", "Level 5 Extent", None))
        self.label_14.setText(_translate("Dialog", "Units", None))
        self.btnViewmetadata.setText(_translate("Dialog", "View Records", None))
