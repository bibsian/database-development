...
pg_dump LTERV2| pg_dump LTERV2 --clean| ssh -C lter@www.how-imodel-it.com "psql popler_test"

pg_dump popler__ -f ~/Desktop/git/database-development/db/backups/popler_backup_$(date +%m-%d-%Y).sql
pg_dump popler__ | pg_dump popler__ --clean | ssh -C lter@www.how-imodel-it.com "psql popler"